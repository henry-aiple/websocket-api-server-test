...
async function test() {
  describe('controllers/v1/research', () => {
    describe('Research', () => {
      it('[/] trigger research', function(done) {
        request(app)
          .post('/v1/research')
          .send({
      ...
      it('[/] add research output and get research', function(done) {
        request(app)
          .post('/v1/research')
          .send({
            email: 'henry@aiple.co',
          ...
          .then((res) => request(app)
            .get(`/v1/research/${res.body.research.researchId}`)
            // .set({
